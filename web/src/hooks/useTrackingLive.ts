...
/**
 * Subscribe to org-scoped live tracking.
 * Hydrates from GET /timesheet-activity/live (so the badge works on page load)
 * and stays in sync via Socket.IO `tracking.updated`.
 */
