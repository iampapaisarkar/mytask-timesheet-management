...
export function Button({
  ...
  return (
    <button
      className={clsx(
        "mt-focus inline-flex min-h-11 cursor-pointer items-center justify-center gap-2 rounded-xl px-4 py-2.5 text-sm font-semibold transition active:scale-[0.98] disabled:cursor-not-allowed disabled:opacity-55",
        variants[variant],
        className,
      )}
