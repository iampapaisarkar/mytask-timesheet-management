import{ca as v,cb as y,cc as T,cd as M,ce as te,cf as j,cg as _e,ch as Ne,ci as Oe,cj as Ce,ck as De,cl as I,cm as E,aK as Re}from"./index-BVXnCZTI.js";const ne="@firebase/installations",F="0.6.18";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Xt(e,t){const n=t.data;if(!n.isFirebaseMessaging)return;e.onMessageHandler&&n.messageType===m.PUSH_RECEIVED&&(typeof e.onMessageHandler=="function"?e.onMessageHandler(Q(n)):e.onMessageHandler.next(Q(n)));const i=n.data;Bt(i)&&i[It]==="1"&&await Yt(e,n.messageType,i)}const Z="@firebase/messaging",ee="0.12.22";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
