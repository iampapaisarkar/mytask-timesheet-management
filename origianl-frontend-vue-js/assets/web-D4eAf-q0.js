import{cd as v,ce as y,cf as T,cg as M,ch as te,ci as j,cj as _e,ck as Ne,cl as Oe,cm as Ce,cn as De,co as I,cp as E,aQ as Re}from"./index-PgeLEOmU.js";const ne="@firebase/installations",F="0.6.18";/**
 * @license
 ...
 */const ie=1e4,oe=`w:${F}`,re="FIS_v2",Pe="https://firebaseinstallations.googleapis.com/v1",Me=3600*1e3,je="installations",Fe="Installations";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const mt="/firebase-messaging-sw.js",vt="/firebase-cloud-messaging-push-scope",ye="BDOU99-h67HcA6JeFXHbSNMu7e2yNNu3RzoMj8TM4W88jITfq7ZmPvIM1Iv-4_l2LxQcYwhqby2xGpWwzjfAnG4",yt="https://fcmregistrations.googleapis.com/v1",Te="google.c.a.c_id",Tt="google.c.a.c_l",kt="google.c.a.ts",It="google.c.a.e",J=1e4;var Y;(function(e){e[e.DATA_MESSAGE=1]="DATA_MESSAGE",e[e.DISPLAY_NOTIFICATION=3]="DISPLAY_NOTIFICATION"})(Y||(Y={}));/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Nt="firebase-messaging-database",Ot=1,h="firebase-messaging-store";let C=null;function L(){return C||(C=j(Nt,Ot,{upgrade:(e,t)=>{switch(t){case 0:e.createObjectStore(h)}}})),C}async function ke(e){const t=V(e),i=await(await L()).transaction(h).objectStore(h).get(t);if(i)return i;{const o=await Et(e.appConfig.senderId);if(o)return await x(e,o),o}}async function x(e,t){const n=V(e),o=(await L()).transaction(h,"readwrite");return await o.objectStore(h).put(t,n),await o.done,t}async function Ct(e){const t=V(e),i=(await L()).transaction(h,"readwrite");await i.objectStore(h).delete(t),await i.done}function V({appConfig:e}){return e.appId}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Mt=10080*60*1e3;async function jt(e){const t=await $t(e.swRegistration,e.vapidKey),n={vapidKey:e.vapidKey,swScope:e.swRegistration.scope,endpoint:t.endpoint,auth:l(t.getKey("auth")),p256dh:l(t.getKey("p256dh"))},i=await ke(e.firebaseDependencies);if(i){if(qt(i.subscriptionOptions,n))return Date.now()>=i.createTime+Mt?Kt(e,{token:i.token,createTime:Date.now(),subscriptionOptions:n}):i.token;try{await Ie(e.firebaseDependencies,i.token)}catch(o){console.warn(o)}return Q(e.firebaseDependencies,n)}else return Q(e.firebaseDependencies,n)}async function Ft(e){const t=await ke(e.firebaseDependencies);t&&(await Ie(e.firebaseDependencies,t.token),await Ct(e.firebaseDependencies));const n=await e.swRegistration.pushManager.getSubscription();return n?n.unsubscribe():!0}async function Kt(e,t){try{const n=await Pt(e.firebaseDependencies,t),i=Object.assign(Object.assign({},t),{token:n,createTime:Date.now()});return await x(e.firebaseDependencies,i),n}catch(n){throw n}}async function Q(e,t){const i={token:await Rt(e,t),createTime:Date.now(),subscriptionOptions:t};return await x(e,i),i.token}async function $t(e,t){const n=await e.pushManager.getSubscription();return n||e.pushManager.subscribe({userVisibleOnly:!0,applicationServerKey:St(t)})}function qt(e,t){const n=t.vapidKey===e.vapidKey,i=t.endpoint===e.endpoint,o=t.auth===e.auth,r=t.p256dh===e.p256dh;return n&&i&&o&&r}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Ae(e){try{e.swRegistration=await navigator.serviceWorker.register(mt,{scope:vt}),e.swRegistration.update().catch(()=>{}),await Wt(e.swRegistration)}catch(t){throw u.create("failed-service-worker-registration",{browserErrorMessage:t?.message})}}async function Wt(e){return new Promise((t,n)=>{const i=setTimeout(()=>n(new Error(`Service worker not registered after ${J} ms`)),J),o=e.installing||e.waiting;e.active?(clearTimeout(i),t()):o?o.onstatechange=r=>{var a;((a=r.target)===null||a===void 0?void 0:a.state)==="activated"&&(o.onstatechange=null,clearTimeout(i),t())}:(clearTimeout(i),n(new Error("No incoming service worker found.")))})}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Gt(e,t){if(!t&&!e.swRegistration&&await Ae(e),!(!t&&e.swRegistration)){if(!(t instanceof ServiceWorkerRegistration))throw u.create("invalid-sw-registration");e.swRegistration=t}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Ee(e,t){if(!navigator)throw u.create("only-available-in-window");if(Notification.permission==="default"&&await Notification.requestPermission(),Notification.permission!=="granted")throw u.create("permission-blocked");return await Jt(e,t?.vapidKey),await Gt(e,t?.serviceWorkerRegistration),jt(e)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Yt(e,t,n){const i=zt(t);(await e.firebaseDependencies.analyticsProvider.get()).logEvent(i,{message_id:n[Te],message_name:n[Tt],message_time:n[kt],message_device_time:Math.floor(Date.now()/1e3)})}function zt(e){switch(e){case m.NOTIFICATION_CLICKED:return"notification_open";case m.PUSH_RECEIVED:return"notification_foreground";default:throw new Error}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Qt(e,t){const n=t.data;if(!n.isFirebaseMessaging)return;e.onMessageHandler&&n.messageType===m.PUSH_RECEIVED&&(typeof e.onMessageHandler=="function"?e.onMessageHandler(X(n)):e.onMessageHandler.next(X(n)));const i=n.data;Bt(i)&&i[It]==="1"&&await Yt(e,n.messageType,i)}const Z="@firebase/messaging",ee="0.12.22";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Xt=e=>{const t=new Ht(e.getProvider("app").getImmediate(),e.getProvider("installations-internal").getImmediate(),e.getProvider("analytics-internal"));return navigator.serviceWorker.addEventListener("message",n=>Qt(t,n)),t},Zt=e=>{const t=e.getProvider("messaging").getImmediate();return{getToken:i=>Ee(t,i)}};function en(){y(new T("messaging",Xt,"PUBLIC")),y(new T("messaging-internal",Zt,"PRIVATE")),v(Z,ee),v(Z,ee,"esm2017")}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function b(){try{await Oe()}catch{return!1}return typeof window<"u"&&Ce()&&De()&&"serviceWorker"in navigator&&"PushManager"in window&&"Notification"in window&&"fetch"in window&&ServiceWorkerRegistration.prototype.hasOwnProperty("showNotification")&&PushSubscription.prototype.hasOwnProperty("getKey")}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function tn(e){if(!navigator)throw u.create("only-available-in-window");return e.swRegistration||await Ae(e),Ft(e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
